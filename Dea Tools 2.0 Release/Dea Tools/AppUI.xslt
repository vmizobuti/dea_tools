...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="9b2fb4d5-fe0e-4912-84d7-77fa6af8aca9" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('bcd98859-1bae-425f-8039-ffff82ac152f')"
                dynamicCategory="2cc24a3e-fe24-4708-9a74-9c75406eebcd"
                userCaption="Dea Tools"
                enable="true"/>

      <!-- Define the web control which will be placed on our docker -->
      <itemData guid="17e5f817-a7c0-417f-a921-05d8a2de88f1"
                type="wpfhost"
                hostedType="Addons\Dea Tools\Dea Tools.dll,Dea_Tools.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="bcd98859-1bae-425f-8039-ffff82ac152f"
                  userCaption="Dea Tools 2.0"
                  wantReturn="true"
                  focusStyle="noThrow"
                  width="0"
                  >
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="17e5f817-a7c0-417f-a921-05d8a2de88f1"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
